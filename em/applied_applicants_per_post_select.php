<?php
    ...
    if (isset($_POST['degree4']) && !empty($_POST['degree4']))
    {
    ...
    if (isset($_POST['degree5']) && !empty($_POST['degree5']))
    {
    ...
    if (isset($_POST['degree6']) && !empty($_POST['degree6']))
    {
    ...
    if (isset($_POST['degree7']) && !empty($_POST['degree7']))
    {
	...
	if(!empty($em_id) && !empty($post_id) && !empty($js_id))
	{
		...
		$query = "INSERT INTO selected_applied_applicants (em_id,post_id,js_id) VALUES ('$em_id','$post_id','$js_id')";
