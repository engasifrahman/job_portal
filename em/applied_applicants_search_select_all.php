<?php
	...
	if(!empty($em_id) && !empty($post_id) && !empty($js_id_str))
	{
        ...
        if (!empty($final_js_id))
        {
            ...
            $query = "INSERT INTO selected_applied_applicants (em_id,post_id,js_id) 
        ...
        else
        {
            ...
            <script type="text/javascript">
                $.notify({
                    ...
                    // toast message
                    message: 'All of those result already exists in your selected list',
