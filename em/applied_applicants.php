<?php
	...
	$query = "SELECT CP.post_id, job_title, job_category, vacancies_no, application_deadline, posted_at, COUNT(js_id), CP.action FROM circular_post CP, applied_job AJ, job_seeker JS WHERE em_id='$em_id' AND CP.post_id=AJ.post_id AND CP.action IN ('Active','Deactive') AND JS.id=AJ.js_id AND JS.action IN ('Active','Deactive') GROUP BY post_id ORDER BY CP.post_id DESC";
                    ...
                    <div class="card">
                        <div class="card-header text-xs-center text-sm-center text-md-center text-lg-center text-xl-center">
                            <h4 class="card-title info" id="personal_info">
                            	<i class="fa fa-paper-plane-o"></i> Applied Applicants Per Circular
                            </h4>
                        </div>
                        <div class="card-body collapse in">
                            <div class="card-block custom-card-block">
                                <div class="col-md-12 col-sm-12 col-xs-12 table_content">
								    ...
								    {
								    	$total_applied_circular=mysqli_num_rows($result);
										?>
										<div class="table-responsive card wizard-card" data-color="green">

											<div class="mt-1 pl-2 col-md-12 text-xs-center text-sm-center text-md-center text-lg-center text-xl-center"><strong class="success">Total Applied Circular: </strong><?php echo $total_applied_circular; ?>
											</div>
												...
												<table id="dtBasicExample" class="table table-bordered mt-1 col-md-12 col-xs-12" cellspacing="0" width="100%">
													<thead>
														<tr class="info">
															...
															<th class="w10 text-sm-center text-md-center text-lg-center text-xl-center">
																Application &nbsp; <i class="fa fa-sort grey" aria-hidden="true"></i>
															</th>
														</tr>
													</thead>
													<?php
													...
													?>
														<tr>
															...
															<td class="w25 text-sm-center text-md-center text-lg-center text-xl-center">
																<a href="aappp?post_id=<?php echo $post_id; ?>"  title="Click to view details"><?php echo $post_data['job_title']; ?> <i class="fa fa-external-link" aria-hidden="true"></i>
																</a>
															</td>
															...
															<td class="w10 text-sm-center text-md-center text-lg-center text-xl-center">
																<a href="aappp?post_id=<?php echo $post_id; ?>"  title="Click to view details">
												...
												?>
													<tfoot>
														<tr class="info">
															...
															<th class="w10 text-sm-center text-md-center text-lg-center text-xl-center">Application</th>
														</tr>
													</tfoot>
												</table>
											</div>
									...
									else
									{
										...
										'
											<div class="text-sm-center text-md-center text-lg-center text-xl-center">
												<strong class="text-warning">Until now, No application are droped for any circular</strong>
											</div>
										';
									}
									?>
