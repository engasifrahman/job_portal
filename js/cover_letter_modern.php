...
<div class="col-md-12 col-xs-12">
  ...
  <div id="cover_letter_modern" style="width:100%;">
    ...
    <div class="col-md-12 text-center" style="margin-bottom: 5px;">
      ...
      ?>
      <div class="col-md-12">
        <div style="letter-spacing: 2px; text-transform: uppercase; color:#538337; font-size: 2rem; margin-bottom: 5px"><?php echo $full_name; ?></div>

        <?php 
        if (!empty($present_address))
        {
          ?>
          <div><small style="font-size: 10px; text-transform: uppercase;"><?php echo $present_address.'  &nbsp; '.$mobile_number.'  &nbsp; '.$email; ?></small></div>
          <?php
        }
        elseif (!empty($permanent_address))
        {
          ?>
          <div><small style="font-size: 10px; text-transform: uppercase;"><?php echo $permanent_address.'  &nbsp; '.$mobile_number.'  &nbsp; '.$email;; ?></small></div>
          <?php
        } 
        ?>
      </div>
...
<script type="text/javascript">
    ...
    $(function(){
      $('#cover_letter_modern').froalaEditor({
