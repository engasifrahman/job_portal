<?php
	...
	$id = $_POST['id'];
	$certificate_name = $_POST['certificate_name_edit'];
	$exam_date = $_POST['exam_date_edit'];
	$expire_date = $_POST['expire_date_edit'];
	$score = $_POST['score_edit'];
	$score_scale = $_POST['score_scale_edit'];

	if(!empty($certificate_name) && !empty($exam_date))
	{

		$query = "UPDATE certifications SET certificate_name='$certificate_name', exam_date='$exam_date', expire_date='$expire_date', score='$score', score_scale='$score_scale' WHERE js_id='$js_id' AND id=$id";
	    ...
	    else
	    {
	    	...
	    	<script type="text/javascript">
	    		$('#certifications_edit_content').slideUp(400); //this is actually hide
