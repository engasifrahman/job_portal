...
<div id="resume_it" class="col-md-12">
  <div class="col-md-12 mobile-device">
    <div id="resume_sidebar" class="col-md-4 col-xs-4 mobile-device pt-1"> <!--here for inline css define the style in script section bellow --> 
      ...
      {
        ?>
        <h4 class="text-bold-500 pl-1" style="margin-bottom: 5px; background-color:#E8E8E8;">Personal Info</h4>
        <?php

        if (!empty($present_address))
        {
          ?>
          <div class="text-bold-400 pl-1">Address</div>
          <div class="pl-1" style="margin-bottom: 5px;"><?php echo $present_address; ?></div>
          <?php
        }
        elseif (!empty($permanent_address))
        {
          ?>
          <div class="text-bold-400 pl-1">Address</div>
          <div class="pl-1" style="margin-bottom: 5px;"><?php echo $permanent_address; ?></div>
          <?php
        }
        ...
        {
          ?>
          <div class="text-bold-400 pl-1">Phone</div>
          <div class="pl-1" style="margin-bottom: 5px;"><?php echo $mobile_number; ?></div>
          <?php
        }
        ...
        {
          ?>
          <div class="text-bold-400 pl-1">Email</div>
          <div class="pl-1"><?php echo $email; ?></div>
          <?php
        }
      }
      ...
      if (mysqli_num_rows($specialization)>0)
      {
        ...
        {
          ?>
          <h4 class="text-bold-500 mt-1 pl-1" style="background-color:#E8E8E8;">Skills</h4>
          <?php

          for($i=0; $i < sizeof($skills); $i++)
          {
            ?>
            <div class="pl-1"><?php echo $skills[$i]; ?></div>
            <?php
          }
        }
      }
      ...
      if (mysqli_num_rows($lan)>0)
      {
        ...
        ?>
        <h4 class="text-bold-500 mt-1 pl-1" style="background-color:#E8E8E8;">Language</h4>
        <?php
        $i=0;
        while($lan_data = mysqli_fetch_assoc($lan))
        {
          $i++;
          ?>
          <div class="pl-1"><?php echo $lan_data['language']; ?></div>
          <div class="col-md-12">
            <div class="progress" <?php if($t==$i){ echo ' ';} else{ echo ' style="margin-bottom: 5px !important"';}?>>
              <div class="progress-bar bg-grey" role="progressbar" style="width: <?php if($lan_data['speaking']=='High'){ echo'100%';} elseif($lan_data['speaking']=='Medium'){ echo'65%';} else{echo'33%';} ?>;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"><?php if($lan_data['speaking']=='High'){ echo'High';} elseif($lan_data['speaking']=='Medium'){ echo'Medium';} else{echo'Low';} ?>
              </div>
            </div>
          </div>
          <?php
      ...
      if (mysqli_num_rows($ref) > 0)
      {
        ?>
        <div>&nbsp;</div>
        <h4 class="text-bold-500 pl-1" style="background-color:#E8E8E8;">References</h4>
        <?php
        $i=1;
    ...
    <?php
      ...
      if (mysqli_num_rows($exp) > 0)
      {
        ...
        <div class="cv_heading col-md-12 col-xs-12 mobile-device">
          <h4 class="text-bold-500">Experience</h4>
          <?php
      ...
      if (mysqli_num_rows($edu) > 0)
      {
        ?>
        <div class="cv_heading col-md-12 col-xs-12 mobile-device">
          <h4 class="text-bold-500">Education</h4>
          <?php
      ...
      if (mysqli_num_rows($certi) > 0)
      {
        ?>
        <div class="cv_heading col-md-12 col-xs-12 mobile-device">
          <h4 class="text-bold-500">Certifications</h4>
          <?php
      ...
      if (mysqli_num_rows($training) > 0)
      {
        ?>
        <div class="cv_heading col-md-12 col-xs-12 mobile-device">
          <h4 class="text-bold-500">Training/Workshop Summary</h4>
          <?php
      ...
      if (!empty($extr_activities))
      {
        ?>
        <div class="cv_heading col-md-12 col-xs-12 mobile-device">
          <h4 class="text-bold-500">Extracurricular Activities</h4>
          <div class="text-justify">
      ...
      <div class="cv_heading col-md-12 col-xs-12 mobile-device">
        <h4 class="text-bold-500">Declaration</h4>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    dh+=100;
    $('#resume_sidebar').css('cssText', 'min-height: '+dh+'px !important;' + 'background-color: #F4F4F4 !important;');
  });

  $(function(){
    $('#resume_it').froalaEditor({
