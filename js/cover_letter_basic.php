...
<div class="col-md-12">
  ...
  <div id="cover_letter_basic" style="width:100%;">
    ...
    <div class="col-md-12 text-center" style="margin-bottom: 5px;">
      ...
      ?>
      <div class="col-md-12">
        <div style="color:black; font-size: 2rem; margin-bottom: 5px"><?php echo $full_name; ?></div>

        <?php 
        if (!empty($present_address))
        {
          ?>
          <div><small style="font-size: 12px;"><?php echo $present_address; ?></small></div>
          <?php
        }
        elseif (!empty($permanent_address))
        {
          ?>
          <div><small style="font-size: 12px;"><?php echo $permanent_address; ?></small></div>
          <?php
        }
        ?>

        <div><small style="font-size: 12px;"><?php echo $mobile_number; ?></small></div>
        <div><small style="font-size: 12px;"><?php echo $email; ?></small></div>
      </div>
...
<script type="text/javascript">
    ...
    $(function(){
      $('#cover_letter_basic').froalaEditor({
