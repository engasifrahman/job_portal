<?php
	...
	$query = "SELECT lesson_title, lesson_content, posted_by, PL.created_at AS posted_at, PL.updated_at AS updated_at, subject  FROM preparation_lesson PL, preparation_sub PS WHERE PL.id='$l_id' AND PS.id=sub_id";
