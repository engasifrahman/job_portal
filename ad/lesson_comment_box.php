<?php
		            ...
		            <div class="row">
		                ...
		                <div class="col-md-12 col-sm-12 col-xs-12 pt-3">
		                    ...
		                    <div class="col-md-9 col-sm-11 col-xs-10 form-group label-floating mobile-device">
		                     ...
		                     <div class="col-md-2 col-sm-12 col-xs-12 text-right mobile-device">
    ...
    if (mysqli_num_rows($result) > 0)
    {
    	...
    	while($row = mysqli_fetch_assoc($result))
    	{
    		...
    		if ($status=='Admin')
    		{
    			$query2 = "SELECT full_name, gender, pic_dir FROM admin WHERE id='$c_id'";
			                ...
			                <div class="col-md-11 col-sm-11 col-xs-10 mb-1 mobile-device">
			                	...
			                	if ($c_id==$ad_id)
			                	{
				                	...
				                	<div class="col-md-2 col-sm-2 col-xs-4 text-right comment_action">
										...
										<a id="<?php echo $row['id']; ?>"  class="comment_delete_own" title="Delete"> 
									            ...
									            <div class="row">
									                <div class="col-md-12 col-sm-12 col-xs-12 pt-2">
									                    <div class="col-md-9 col-sm-12 col-xs-12 form-group label-floating mobile-device">
									                     ...
									                     <div class="col-md-3 col-sm-12 col-xs-12 text-right mobile-device">
			    	...
			    	while($row2 = mysqli_fetch_assoc($result2))
			    	{
			    		...
			    		<div class="col-md-12 mobile-device">
			                ...
			                <div class="col-md-11 col-sm-11 col-xs-10 mb-1 mobile-device">
		                		...
		                		<div class="col-md-10 col-sm-10 col-xs-10 font-small-1 mobile-device">
		                			<?php echo '<b>'.$name.'</b> &nbsp; <i class="fa fa-clock-o" aria-hidden="true"></i> '.$commented_at; ?>
		                		</div>

			                	<div class="col-md-2 col-sm-2 col-xs-2 text-right comment_action">
									<a id="<?php echo $row['id'].','.$row['c_id']; ?>"  class="comment_delete_user" title="Delete"> 
				                        <i class="fa fa-trash-o fa-lg text-danger"></i>
				                    </a>
			                	</div>
...
<script type="text/javascript">
    ...
    //############################### BEGIN DELETE_OWN ##############################//
	$('.comment_delete_own').click(function() {
		var id = $(this).attr('id');
		var l_id = '<?php echo $l_id; ?>';
    	var action = 'Delete_Own';
    ...
    //############################### BEGIN DELETE_USER ##############################//
	$('.comment_delete_user').click(function() {
		...
		$.ajax({
		    url : "comment_oparation",
		    type: "POST",
		    data : { id:id, l_id:l_id, c_id:c_id, action:action },
		    success: function(data)
		    {
		    	$('#comment_view').show().html(data);
		    }
