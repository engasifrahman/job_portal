...
<script type="text/javascript">
    ...
    $('button[name="settings_update"]').click(function(e){
        ...
        $.ajax({
            ...
            beforeSend: function() {
                $('#settings_notification_content').show().fadeOut(6100).html('<div class="text-sm-center text-md-center text-lg-center text-xl-center m-1">LOADING...</div>');
            },
            success: function (data) {
                $('#settings_notification_content').show().fadeOut(6100).html(data);
            },
            error: function() {
                $('#settings_notification_content').show().html('<div class="text-sm-center text-md-center text-lg-center text-xl-center">Error here</div>');
            }
      });
