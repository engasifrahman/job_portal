<?php
	...
	$old_uname_n_ad_uname_match=0;
	$new_uname_n_old_uname_unmatch=0;
	$old_email_n_ad_email_match=0;
	$new_email_n_old_email_unmatch=0;
	$old_pass_n_ad_pass_match=0;
	...
	if (!empty($_POST['old_uname']) && !empty($_POST['new_uname']) && !empty($_POST['old_email']) && !empty($_POST['new_email']) && !empty($_POST['old_pass']) && !empty($_POST['new_pass']) && !empty($_POST['confirm_pass']))
	{
		...
		if ($_POST['old_uname']==$ad_uname)
		{
			$old_uname_n_ad_uname_match=1;
		}
		if ($_POST['new_uname']!=$ad_uname)
		{
			$new_uname_n_old_uname_unmatch=1;
		}


		if ($_POST['old_email']==$ad_email)
		{
			$old_email_n_ad_email_match=1;
		}
		if ($_POST['new_email']!=$ad_email)
		{
			$new_email_n_old_email_unmatch=1;
		}


		if (md5(md5($_POST['old_pass']))==$ad_pass)
		{
			$old_pass_n_ad_pass_match=1;
		}
		if (md5(md5($_POST['new_pass']))!=$ad_pass)
		{
		...
		if ($old_uname_n_ad_uname_match==1 && $new_uname_n_old_uname_unmatch==1 && $old_email_n_ad_email_match==1 && $new_email_n_old_email_unmatch==1 && $old_pass_n_ad_pass_match==1 && $new_pass_n_old_pass_unmatch==1 && $new_pass_n_cpass_match==1)
		{
	...
	elseif (!empty($_POST['old_uname']) && !empty($_POST['new_uname']) && !empty($_POST['old_email']) && !empty($_POST['new_email']) && empty($_POST['old_pass']) && empty($_POST['new_pass']) && empty($_POST['confirm_pass']))
	{
		...
		if ($old_uname_n_ad_uname_match==1 && $new_uname_n_old_uname_unmatch==1 && $old_email_n_ad_email_match==1 && $new_email_n_old_email_unmatch==1)
		{
	...
	elseif (empty($_POST['old_uname']) && empty($_POST['new_uname']) && !empty($_POST['old_email']) && !empty($_POST['new_email']) && !empty($_POST['old_pass']) && !empty($_POST['new_pass']) && !empty($_POST['confirm_pass']))
	{
		...
		if ($old_email_n_ad_email_match==1 && $new_email_n_old_email_unmatch==1 && $old_pass_n_ad_pass_match==1 && $new_pass_n_old_pass_unmatch==1 && $new_pass_n_cpass_match==1)
		{
			$email_pass_update=1;
		}
	}
	...
	elseif (!empty($_POST['old_uname']) && !empty($_POST['new_uname']) && empty($_POST['old_email']) && empty($_POST['new_email']) && !empty($_POST['old_pass']) && !empty($_POST['new_pass']) && !empty($_POST['confirm_pass']))
	{
		...
		if ($old_uname_n_ad_uname_match==1 && $new_uname_n_old_uname_unmatch==1 && $old_pass_n_ad_pass_match==1 && $new_pass_n_old_pass_unmatch==1 && $new_pass_n_cpass_match==1)
		{
			$uname_pass_update=1;
		}
	}
	...
	elseif (!empty($_POST['old_uname']) && !empty($_POST['new_uname']) && empty($_POST['old_email']) && empty($_POST['new_email']) && empty($_POST['old_pass']) && empty($_POST['new_pass']) && empty($_POST['confirm_pass']))
	{
		...
		if ($old_uname_n_ad_uname_match==1 && $new_uname_n_old_uname_unmatch==1)
		{
			$uname_update=1;
		}
	}
	...
	elseif (empty($_POST['old_uname']) && empty($_POST['new_uname']) && !empty($_POST['old_email']) && !empty($_POST['new_email']) && empty($_POST['old_pass']) && empty($_POST['new_pass']) && empty($_POST['confirm_pass']))
	{
		...
		if ( $old_email_n_ad_email_match==1 && $new_email_n_old_email_unmatch==1)
		{
			$email_update=1;
		}
	}
	...
	elseif (empty($_POST['old_uname']) && empty($_POST['new_uname']) && empty($_POST['old_email']) && empty($_POST['new_email']) && !empty($_POST['old_pass']) && !empty($_POST['new_pass']) && !empty($_POST['confirm_pass']))
	{
		...
		if ($old_pass_n_ad_pass_match==1 && $new_pass_n_old_pass_unmatch==1 && $new_pass_n_cpass_match==1)
		{
			$pass_update=1;
		}
	}
	...
	if ($uname_email_pass_update==1) 
	{
		...
		$query = "UPDATE admin SET email='$new_email', username='$new_uname', password='$new_pass' WHERE id='$ad_id'";
	    ...
	    else
	    {
	    	...
	    	$_SESSION['ad_info']['email']=$new_email;
	    	$_SESSION['ad_info']['uname']=$new_uname;
	    	$_SESSION['ad_info']['pass']=$new_pass;
	...
	elseif ($uname_email_update==1) 
	{
		...
		$query = "UPDATE admin SET email='$new_email', username='$new_uname' WHERE id='$ad_id'";
	...
	elseif ($email_pass_update==1) 
	{
		...
		$query = "UPDATE admin SET email='$new_email', password='$new_pass' WHERE id='$ad_id'";
	...
	elseif ($uname_pass_update==1) 
	{
		...
		$query = "UPDATE admin SET username='$new_uname', password='$new_pass' WHERE id='$ad_id'";
	...
	elseif ($uname_update==1) 
	{
		...
		$query = "UPDATE admin SET username='$new_uname' WHERE id='$ad_id'";
	...
	elseif ($email_update==1) 
	{
		...
		$query = "UPDATE admin SET email='$new_email' WHERE id='$ad_id'";
	...
	elseif ($pass_update==1) 
	{
		...
		$query = "UPDATE admin SET password='$new_pass' WHERE id='$ad_id'";
	...
	if (($uname_email_pass_check==1 || $uname_email_check==1 || $uname_pass_check==1 || $uname_check==1) && $old_uname_n_ad_uname_match==0)
	{
		?>
		<script type="text/javascript">
			$.notify({
	...
	elseif(($uname_email_pass_check==1 || $uname_email_check==1 || $email_pass_check==1 || $email_check==1) && $old_email_n_ad_email_match==0)
	{
		?>
		<script type="text/javascript">
			$.notify({
	...
	elseif(($uname_email_pass_check==1 || $email_pass_check==1 || $uname_pass_check==1 || $pass_check==1) && $old_pass_n_ad_pass_match==0)
	{
		?>
		<script type="text/javascript">
			$.notify({
